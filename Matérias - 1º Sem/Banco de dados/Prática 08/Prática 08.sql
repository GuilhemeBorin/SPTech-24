...
('AxolotesAvante', 'Controle de Temperatura da água dos Axolotes'),
('CoffeRadar', 'Monitoramento do controle temperatura da torra de café');

-- Inserir dados na tabela Aluno
INSERT INTO Aluno (RA, NomeAluno, Email, IDGrupo) VALUES
(01232168, 'Gabriel Borin', 'gabriel@gmail.com', 1),
(01241215, 'Maria Brasil', 'maria@gmail.com', 1),
(01241083, 'Natasha Pereira', 'matasha@gmail.com', 2),
(01232559, 'Berta Moreira', 'berta@gmail.com', 2);

-- Inserir dados na tabela Professor
INSERT INTO Professor (NomeProfessor, Disciplina, IDGrupo) VALUES
('Marcelão', 'Projeto e Inovação', 1),
('Brandinho', 'Sistemas de Informação', 2);

-- Inserir dados na tabela AvaliacaoGrupo
INSERT INTO AvaliacaoGrupo (IDGrupo, IDProfessor, DataInicio, Nota) VALUES
(1, 2, '2024-05-26 07:30:00', 9.5),
(1, 1, '2024-02-18 07:45:00', 6.0),
(2, 1, '2024-09-21 12:00:00', 7.3),
(2, 2, '2024-12-08 13:30:00', 8.5);
